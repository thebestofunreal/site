...
<meta charset="utf-8">
<!-- Подключение файлов из папок: css, js и так далее -->
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>The Best Of Unreal<br>
							 Главная страница</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Мы - группа разработчиков, которые занимаются созданием сайтов. Мы - профессионалы своего дела, нам можно доверить работу. 
							</p>
						</div>
					</div>
				</div>
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/car.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									Мы используем Discord для общения как между собой, так и для общения с подписчиками, комментаторами, с людьми, которые вносят вклад в наш сайт, наш социум, нашу точку зрения.
									Мы читаем абссолютно все сообщения, отзывы, жалобы и другого рода сообщения, которые поступают в наши информационные поля. Список всех наших контактов приведен на отдельной 
									странице.
								</p>
							</div>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									Различные программы, элементы кода и код сайта - все это Вы можете найти на нашем профиле Github. Последние коммиты, обновления, доработки, все самое свежее из нашей продукции 
									именно там!
								</p>
							</div>
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 Если вы еще не покинули наш сайт, то можно сделать вывод, что наши коллеги, отвечающие за контент и просматриваемость, достойно поработали. Здесь заканчивается главная 
									 страница нашего сайта, чуть ниже приведены все вкладки на нашем сайте, можете ознакомиться и с ними.
								</p>
							</div>
						</div>
					</div>
